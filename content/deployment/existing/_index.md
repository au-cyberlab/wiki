...
1. `aws_infrastructure/deployment_config.yml`
    ...
    > [!TIP]
    > To deploy *groups* of base configs, specify [lab configs](../existing/lab-configs/).
...
2. `ansible/playbooks/plays_to_run.yml`
    ...
    > [!TIP]
    > To control the order of execution, use multiple [batches](../existing/batches/). Playbooks run concurrently by default.

This should be enough to deploy an existing system (or set of systems).
